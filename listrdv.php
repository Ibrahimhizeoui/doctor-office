...
<head>
  ...
  <title>Les Rendez Vous | Doctor Park </title>
			...
			<div class="panel-body">
				<div class="table-responsive">
					<table class="table table-bordered table-hover table-striped display" id="example">
						...
						<tbody>
							<?php 
							 $select=$bdd->prepare("SELECT *,DATE_FORMAT(date, '%Y-%m-%dT%H:%i:%s') as d , Now() as dd FROM `rdv` order by date desc ");
								 $select->execute();
								 while($s=$select->fetch()){
									 $t=$s['idp'];
									 $x=$s['id'];
									 $n=$s['nature'];
									 $select2=$bdd->prepare("SELECT nom,prenom,tel,email,typeimg,id FROM `patiant` ");
								     $select2->execute();
									 $s1=$select2->fetch();
									 $d=$s1['nom']." ".$s1['prenom'];
									 ?>
			...
			<div class="modal-content">
				...
				<div class="modal-body" style="display:inline-block;width:100%">
				 ...
				 <div class="form-group">
						...
						<div class="col-sm-3">
							<input  name="date" type="text" class="form-control" value="<?php echo $s['date']; ?>" id="date-popup" data-provide="datepicker">
						</div>
						<div class="col-sm-3">
							<input name="time" type="time" value="<?php echo $s['time']; ?>" class="form-control" data-validation="date" data-validation-optional="true">
						</div>
						<div class="col-sm-3">
							<select class="form-control" name="nature" data-validation="required" data-validation-error-msg="Please make a choice">
					...
					<label class="col-sm-2 control-label" style="margin-top:20px;"style="visibility: hidden;margin-top:20px;"></label>
						<div class="col-sm-3" style="margin-top:20px;">
							<select class="form-control" name="type" >
								<option value="value="<?php echo $s['type']; ?>"">La place du consultation  -</option>
